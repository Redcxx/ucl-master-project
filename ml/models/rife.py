...
from ml.options.rife import RIFEInferenceOptions, RIFETrainOptions


class RIFEInferenceModel(BaseInferenceModel):

    def __init__(self, opt: RIFEInferenceOptions, inference_loader: DataLoader):
...
class RIFETrainModel(BaseTrainModel):

    def __init__(self, opt: RIFETrainOptions, train_loader, test_loader):

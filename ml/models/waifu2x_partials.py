...
class MeanShift(nn.Module):
    def __init__(self, mean_rgb, sub):
        ...
        self.shifter = nn.Conv2d(3, 3, (1, 1), (1, 1), 0)
...
class EResidualBlock(nn.Module):
    def __init__(self,
        ...
        self.body = nn.Sequential(
            nn.Conv2d(in_channels, out_channels, (3, 3), (1, 1), 1, groups=group),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channels, out_channels, (3, 3), (1, 1), 1, groups=group),
            nn.ReLU(inplace=True),
...
class Block(nn.Module):
    def __init__(self,
        ...
        self.b1 = EResidualBlock(in_channels, out_channels, group=group)
...
class Net(nn.Module):
    def __init__(self, scale, multi_scale, group=1):
        super(Net, self).__init__()

        self.sub_mean = MeanShift((0.4488, 0.4371, 0.4040), sub=True)
        self.add_mean = MeanShift((0.4488, 0.4371, 0.4040), sub=False)

        self.entry = nn.Conv2d(3, 64, (3, 3), (1, 1), 1)
        ...
        self.upsample = UpsampleBlock(64, scale=scale,
                                      ...
                                      group=group)
        self.exit = nn.Conv2d(64, 3, (3, 3), (1, 1), 1)
